...
c.abort=function(a){1===a.length&&"number"===typeof a[0]?window.setTimeout(c.xhr.abort(),a[0]):c.xhr.abort()}}d.prototype.request=function(c){this.req(c)};d.prototype.cancel=function(){this.abort(arguments)};e.SeXHR=d;e.sexhr=d})(window);